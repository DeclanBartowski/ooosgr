                                ...
                                >
                                    ...
                                    <div class="chosen-drop">
                                        ...
                                        <ul class="chosen-results">
                                            ...
                                            <div v-else>
                                                <li v-for="diameter in data.diameter"
                                                    @click="choseDiameter(diameter.name)" class="active-result"
                                                    :data-option-array-index="diameter.value">
                                                    {{ diameter.name }}
                                                </li>
                                            </div>
                                ...
                                >
                                    ...
                                    <div class="chosen-drop">
                                        ...
                                        <ul class="chosen-results">
                                            ...
                                            <div v-else>
                                                <li v-for="wall in data.wall" @click="choseWall(wall.name)"
                                                    class="active-result" :data-option-array-index="wall.value">
                                                    {{ wall.name }}
                                                </li>
                                            </div>
                                        </ul>
