                  ...
                  <div>
                    <label>
                      ...
                      <span class="b24-form-control-desc">
                        <span class="b24-form-field-agreement-link">Нажимая кнопку «Отправить», я даю свое согласие на обработку моих персональных данных, в соответствии с Федеральным законом от 27.07.2006 года №152-ФЗ «О персональных данных», на условиях и для целей, определенных в Согласии на обработку персональных данных * </span>
                      </span>
                      <span class="b24-form-control-required">*</span>
                      <div
                          class="b24-form-control-alert-message"
...
.b24-form-header-title {
  ...
  font-weight: 400;
  font-size: calc(20px + (28 + 28 * 0.2) * ((100vw - 392px) / 1920));
  word-break: break-word
}
...
.b24-form-header-description {
  ...
  font-family: 'Open Sans', sans-serif;
  font-weight: 300;
  font-size: calc(16px + (24 + 24 * 0.2) * ((100vw - 392px) / 1920));
  opacity: .8;
  word-break: break-word
}
...
.b24-form-control-checkbox .b24-form-control-label, .b24-form-control-radio .b24-form-control-label, .b24-form-control-product .b24-form-control-label {
  ...
  font-family: 'Open Sans', sans-serif;
  font-weight: 400;
  font-size: calc(18px + (4 + 4 * 0.2) * ((100vw - 392px) / 1920));
}
...
.b24-form-field-agreement .b24-form-field-agreement-link {
  font-size: calc(14px + (6 + 6 * 0.2) * ((100vw - 392px) / 1920));
  line-height: normal;
  font-family: 'Open Sans', sans-serif;
  font-weight: 300;
  cursor: pointer;
